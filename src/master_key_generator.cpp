...
namespace walletpp {
    std::unique_ptr<extended_key> master_key_generator::generate_private_key(const Botan::secure_vector<uint8_t> &seed) {
    ...
    std::unique_ptr<key_pair> master_key_generator::generate_master_key_pair(const Botan::secure_vector<uint8_t> &seed) {
