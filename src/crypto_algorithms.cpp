...
namespace walletpp {
    std::array<uint8_t, sha256_output_byte_size> crypto_algorithms::sha256(const Botan::secure_vector<uint8_t> &contents) {
    ...
    std::array<uint8_t, sha256_output_byte_size> crypto_algorithms::double_sha256(const Botan::secure_vector<uint8_t> &contents) {
        const auto hash1 = Botan::HashFunction::create_or_throw("SHA-256");
